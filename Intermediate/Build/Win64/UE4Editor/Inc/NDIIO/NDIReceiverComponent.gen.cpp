...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNDIReceiverComponent_ChangeConnection_Statics::Function_MetaDataParams[] = {
		{ "Category", "NDI IO" },
		{ "Comment", "/** \n\x09\x09\x09""Attempt to change the connection for which to get audio, video, and metadata frame from \n\x09\x09*/" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNDIReceiverComponent_GetCurrentConnectionInformation_Statics::Function_MetaDataParams[] = {
		{ "Category", "NDI IO" },
		{ "Comment", "/** \n\x09\x09\x09Returns the current connection information of the connected source \n\x09\x09*/" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNDIReceiverComponent_GetCurrentFrameRate_Statics::Function_MetaDataParams[] = {
		{ "Category", "NDI IO" },
		{ "Comment", "/** \n\x09\x09\x09Returns the current framerate of the connected source\n\x09\x09*/" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNDIReceiverComponent_GetCurrentTimecode_Statics::Function_MetaDataParams[] = {
		{ "Category", "NDI IO" },
		{ "Comment", "/** \n\x09\x09\x09Returns the current timecode of the connected source\n\x09\x09*/" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNDIReceiverComponent_GetPerformanceData_Statics::Function_MetaDataParams[] = {
		{ "Category", "NDI IO" },
		{ "Comment", "/** \n\x09\x09\x09Returns the current performance data of the receiver while connected to the source\n\x09\x09*/" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNDIReceiverComponent_SendMetadataFrame_Statics::Function_MetaDataParams[] = {
		{ "Category", "NDI IO" },
		{ "Comment", "/**\n\x09\x09\x09This will add a metadata frame and return immediately, having scheduled the frame asynchronously\n\x09\x09*/" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNDIReceiverComponent_SendTallyInformation_Statics::Function_MetaDataParams[] = {
		{ "Category", "NDI IO" },
		{ "Comment", "/** \n\x09\x09\x09This will setup the up-stream tally notifications. If no streams are connected, it will automatically send \n\x09\x09\x09the tally state upon connection\n\x09\x09*/" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNDIReceiverComponent_ShutdownReceiver_Statics::Function_MetaDataParams[] = {
		{ "Category", "NDI IO" },
		{ "Comment", "/** \n\x09\x09\x09""Attempts to stop receiving audio, video, and metadata frame from the connected source \n\x09\x09*/" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNDIReceiverComponent_StartReceiver_Statics::Function_MetaDataParams[] = {
		{ "Category", "NDI IO" },
		{ "Comment", "/** \n\x09\x09\x09""Begin receiving NDI audio, video, and metadata frames \n\x09\x09*/" },
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UNDIReceiverComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UNDIReceiverComponent_ChangeConnection, "ChangeConnection" }, // 170639723
		{ &Z_Construct_UFunction_UNDIReceiverComponent_GetCurrentConnectionInformation, "GetCurrentConnectionInformation" }, // 1842950649
		{ &Z_Construct_UFunction_UNDIReceiverComponent_GetCurrentFrameRate, "GetCurrentFrameRate" }, // 1965982297
		{ &Z_Construct_UFunction_UNDIReceiverComponent_GetCurrentTimecode, "GetCurrentTimecode" }, // 3982330453
		{ &Z_Construct_UFunction_UNDIReceiverComponent_GetPerformanceData, "GetPerformanceData" }, // 3144791759
		{ &Z_Construct_UFunction_UNDIReceiverComponent_SendMetadataFrame, "SendMetadataFrame" }, // 2991154176
		{ &Z_Construct_UFunction_UNDIReceiverComponent_SendTallyInformation, "SendTallyInformation" }, // 3249583747
		{ &Z_Construct_UFunction_UNDIReceiverComponent_ShutdownReceiver, "ShutdownReceiver" }, // 1421988309
		{ &Z_Construct_UFunction_UNDIReceiverComponent_StartReceiver, "StartReceiver" }, // 1474395167
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNDIReceiverComponent_Statics::NewProp_NDIMediaSource_MetaData[] = {
		...
		{ "Category", "Properties" },
		{ "Comment", "/** The NDI Media Receiver representing the configuration of the network source to receive audio, video, and metadata from */" },
		{ "DisplayName", "NDI Media Source" },
		{ "ModuleRelativePath", "Public/Components/NDIReceiverComponent.h" },
		{ "ToolTip", "The NDI Media Receiver representing the configuration of the network source to receive audio, video, and metadata from" },
	};
#endif
	...
	IMPLEMENT_CLASS(UNDIReceiverComponent, 2411616278);
