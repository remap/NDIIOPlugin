...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNDIMediaReceiver_ChangeVideoTexture_Statics::Function_MetaDataParams[] = {
		{ "BlueprintSetter", "" },
		{ "Comment", "/** \n\x09\x09\x09""Attempts to change the Video Texture object used as the video frame capture object\n\x09\x09*/" },
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UNDIMediaReceiver_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UNDIMediaReceiver_ChangeVideoTexture, "ChangeVideoTexture" }, // 1281027888
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNDIMediaReceiver_Statics::NewProp_VideoTexture_MetaData[] = {
		...
		{ "Category", "Content" },
		{ "Comment", "/** \n\x09\x09\x09Provides an NDI Video Texture object to render videos frames from the source onto \n\x09\x09*/" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNDIMediaReceiver_Statics::NewProp_PerformanceData_MetaData[] = {
		...
		{ "Comment", "/** \n\x09\x09\x09Information describing detailed information about the receiver performance when connected to an NDI? sender\n\x09\x09*/" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNDIMediaReceiver_Statics::NewProp_ConnectionInformation_MetaData[] = {
		{ "AllowPrivateAccess", "TRUE" },
		{ "Category", "Information" },
		{ "Comment", "/** \n\x09\x09\x09Information describing detailed information about the sender this receiver is connected to\n\x09\x09*/" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNDIMediaReceiver_Statics::NewProp_bSyncTimecodeToSource_MetaData[] = {
		{ "AllowPrivateAccess", "TRUE" },
		{ "Category", "Settings" },
		{ "Comment", "/** \n\x09\x09\x09Indicates whether the timecode should be synced to the Source Timecode value\n\x09\x09*/" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNDIMediaReceiver_Statics::NewProp_FrameRate_MetaData[] = {
		{ "AllowPrivateAccess", "TRUE" },
		{ "Category", "Information" },
		{ "Comment", "/** \n\x09\x09\x09The desired number of frames (per second) for video to be displayed\n\x09\x09*/" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNDIMediaReceiver_Statics::NewProp_Timecode_MetaData[] = {
		{ "AllowPrivateAccess", "TRUE" },
		{ "Category", "Information" },
		{ "Comment", "/** \n\x09\x09\x09The current frame count, seconds, minutes, and hours in time-code notation\n\x09\x09*/" },
	...
	IMPLEMENT_CLASS(UNDIMediaReceiver, 3032378820);
