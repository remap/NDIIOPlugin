...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNDIIOLibrary_K2_BeginBroadcastingActiveViewport_Statics::Function_MetaDataParams[] = {
		...
		{ "Category", "NDI IO" },
		{ "Comment", "/** \n\x09\x09\x09""Attempts to start broadcasting the active viewport. The output of the active viewport is the current camera\n\x09\x09\x09that is actively being viewed (through), and does not have to be an NDI Broadcast Viewport Component.\n\n\x09\x09\x09@return The result of whether broadcasting the active viewport was started\n\x09\x09*/" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNDIIOLibrary_K2_FindNetworkSourceByName_Statics::Function_MetaDataParams[] = {
		{ "AllowPrivateAccess", "TRUE" },
		{ "Category", "NDI IO" },
		{ "Comment", "/** \n\x09\x09\x09""Attempts to search the NDI Source Collection for the source name, returning a result indicating \n\x09\x09\x09success with the ConnectionInformation parameter filled with the found connection\n\n\x09\x09\x09@param ConnectionInformation The connection information for a successful find with the supplied InSourceName\n\x09\x09\x09@param InSourceName The name of the source to find within the collection of NDI sources\n\n\x09\x09\x09@return The result of whether the search was successful\n\x09\x09*/" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNDIIOLibrary_K2_GetNDIMediaReceiver_Statics::Function_MetaDataParams[] = {
		{ "AllowPrivateAccess", "TRUE" },
		{ "Category", "NDI IO" },
		{ "Comment", "/** \n\x09\x09\x09Returns an NDI Media Receiver object\n\n\x09\x09\x09@param Receiver The Receiver object to return\n\x09\x09\x09@return The selected Receiver object\n\x09\x09*/" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNDIIOLibrary_K2_GetNDIMediaSender_Statics::Function_MetaDataParams[] = {
		{ "AllowPrivateAccess", "TRUE" },
		{ "Category", "NDI IO" },
		{ "Comment", "/** \n\x09\x09\x09Returns an NDI Media Sender object\n\n\x09\x09\x09@param Sender The Sender object to return\n\x09\x09\x09@return The selected Sender object\n\x09\x09*/" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNDIIOLibrary_K2_GetNDISourceCollection_Statics::Function_MetaDataParams[] = {
		{ "AllowPrivateAccess", "TRUE" },
		{ "Category", "NDI IO" },
		{ "Comment", "/** \n\x09\x09\x09Retrieves a collection of NDI sources appearing on the network\n\n\x09\x09\x09@return A collection of NDI Sources appearing on the network\n\x09\x09*/" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNDIIOLibrary_K2_StopBroadcastingActiveViewport_Statics::Function_MetaDataParams[] = {
		{ "AllowPrivateAccess", "TRUE" },
		{ "Category", "NDI IO" },
		{ "Comment", "/** \n\x09\x09\x09Will stop broadcasting the active viewport, which was started by a previous call to 'Begin Broadcasting Active Viewport'\n\x09\x09*/" },
		{ "DefaultToSelf", "WorldContextObject" },
		{ "DisplayName", "Stop Broadcasting Active Viewport" },
		{ "HidePin", "WorldContextObject" },
		{ "ModuleRelativePath", "Public/Objects/Libraries/NDIIOLibrary.h" },
		{ "ToolTip", "Will stop broadcasting the active viewport, which was started by a previous call to 'Begin Broadcasting Active Viewport'" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UNDIIOLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UNDIIOLibrary_K2_BeginBroadcastingActiveViewport, "K2_BeginBroadcastingActiveViewport" }, // 3579769857
		{ &Z_Construct_UFunction_UNDIIOLibrary_K2_FindNetworkSourceByName, "K2_FindNetworkSourceByName" }, // 1256919803
		{ &Z_Construct_UFunction_UNDIIOLibrary_K2_GetNDIMediaReceiver, "K2_GetNDIMediaReceiver" }, // 518743295
		{ &Z_Construct_UFunction_UNDIIOLibrary_K2_GetNDIMediaSender, "K2_GetNDIMediaSender" }, // 3819046190
		{ &Z_Construct_UFunction_UNDIIOLibrary_K2_GetNDISourceCollection, "K2_GetNDISourceCollection" }, // 982073283
		{ &Z_Construct_UFunction_UNDIIOLibrary_K2_StopBroadcastingActiveViewport, "K2_StopBroadcastingActiveViewport" }, // 1569279785
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UNDIIOLibrary, 3759005737);
