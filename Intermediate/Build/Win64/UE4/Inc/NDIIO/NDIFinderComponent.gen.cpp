...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNDIFinderComponent_FindNetworkSourceByName_Statics::Function_MetaDataParams[] = {
		{ "Category", "NDI IO" },
		{ "Comment", "/** \n\x09\x09\x09""Attempts to find a network source by the supplied name.\n\n\x09\x09\x09@param ConnectionInformation An existing source information structure which contains the source name\n\x09\x09\x09@param InSourceName A string value representing the name of the source to find\n\x09\x09\x09@result A value indicating whether a source with the supplied name was found\n\x09\x09*/" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNDIFinderComponent_GetNetworkSources_Statics::Function_MetaDataParams[] = {
		{ "Category", "NDI IO" },
		{ "Comment", "/** \n\x09\x09\x09Returns the current collection of sources found on the network\n\x09\x09*/" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNDIFinderComponent_OnNetworkSourceCollectionChangedEvent_Statics::Function_MetaDataParams[] = {
		{ "Comment", "/** \n\x09\x09\x09""An Event handler for when the NDI Finder Service notifies listeners that changes have been\n\x09\x09\x09""detected in the network source collection \n\x09\x09*/" },
		{ "ModuleRelativePath", "Public/Components/NDIFinderComponent.h" },
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UNDIFinderComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UNDIFinderComponent_FindNetworkSourceByName, "FindNetworkSourceByName" }, // 3137537476
		{ &Z_Construct_UFunction_UNDIFinderComponent_GetNetworkSources, "GetNetworkSources" }, // 2246855357
		{ &Z_Construct_UFunction_UNDIFinderComponent_OnNetworkSourceCollectionChangedEvent, "OnNetworkSourceCollectionChangedEvent" }, // 706814656
	...
	IMPLEMENT_CLASS(UNDIFinderComponent, 3010967000);
