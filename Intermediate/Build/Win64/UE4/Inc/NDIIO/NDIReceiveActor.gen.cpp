...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ANDIReceiveActor_Statics::NewProp_bEnableAudioPlayback_MetaData[] = {
		...
		{ "Category", "NDI IO|Media" },
		{ "Comment", "/** \n\x09\x09\x09Indicates that this object should play the audio. \n\n\x09\x09\x09*Note Audio played by this object will be played as a UI sound, and won't normalize the audio\n\x09\x09\x09\x09  if the same 'MediaSource' object is being used as the audio source on multiple receivers.\x09\n\x09\x09*/" },
	...
	IMPLEMENT_CLASS(ANDIReceiveActor, 2267166022);
