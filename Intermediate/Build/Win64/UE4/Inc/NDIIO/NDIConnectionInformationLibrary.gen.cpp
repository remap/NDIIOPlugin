...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNDIConnectionInformationLibrary_K2_Compare_NDIConnectionInformation_Statics::Function_MetaDataParams[] = {
		...
		{ "Category", "NDI IO" },
		{ "Comment", "/** \n\x09\x09\x09Returns a value indicating whether the two structures are comparably equal\n\n\x09\x09\x09@param A The structure used as the source comparator\n\x09\x09\x09@param B The structure used as the target comparator\n\x09\x09\x09@return The resulting value of the comparator operator\n\x09\x09*/" },
		{ "CompactNodeTitle", "==" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNDIConnectionInformationLibrary_K2_Compare_Not_NDIConnectionInformation_Statics::Function_MetaDataParams[] = {
		{ "AllowPrivateAccess", "TRUE" },
		{ "Category", "NDI IO" },
		{ "Comment", "/** \n\x09\x09\x09Returns a value indicating whether the two structures are NOT comparably equal\n\n\x09\x09\x09@param A The structure used as the source comparator\n\x09\x09\x09@param B The structure used as the target comparator\n\x09\x09\x09@return The resulting value of the comparator operator\n\x09\x09*/" },
		{ "CompactNodeTitle", "!=" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNDIConnectionInformationLibrary_K2_NDIConnectionInformation_IsValid_Statics::Function_MetaDataParams[] = {
		{ "AllowPrivateAccess", "TRUE" },
		{ "Category", "NDI IO" },
		{ "Comment", "/** \n\x09\x09\x09Returns a value indicating whether the property values of the supplied structure is valid\n\n\x09\x09\x09@param ConnectionInformation The structure to validate\n\x09\x09\x09@return An indication of the supplied structures validity\n\x09\x09*/" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNDIConnectionInformationLibrary_K2_NDIConnectionInformation_Reset_Statics::Function_MetaDataParams[] = {
		{ "AllowPrivateAccess", "TRUE" },
		{ "Category", "NDI IO" },
		{ "Comment", "/**\n\x09\x09\x09Resets the structure's properties to their default values\n\n\x09\x09\x09@param ConnectionInformation The structure to reset to the default value\n\x09\x09\x09@return The reference to the passed in structure after the 'reset' has been completed\n\x09\x09*/" },
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UNDIConnectionInformationLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UNDIConnectionInformationLibrary_K2_Compare_NDIConnectionInformation, "K2_Compare_NDIConnectionInformation" }, // 1897639221
		{ &Z_Construct_UFunction_UNDIConnectionInformationLibrary_K2_Compare_Not_NDIConnectionInformation, "K2_Compare_Not_NDIConnectionInformation" }, // 296520556
		{ &Z_Construct_UFunction_UNDIConnectionInformationLibrary_K2_NDIConnectionInformation_IsValid, "K2_NDIConnectionInformation_IsValid" }, // 4248377331
		{ &Z_Construct_UFunction_UNDIConnectionInformationLibrary_K2_NDIConnectionInformation_Reset, "K2_NDIConnectionInformation_Reset" }, // 602084896
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UNDIConnectionInformationLibrary, 1569564680);
